      ...
      <div className="flex flex-col md:flex-row my-10 mx-10 md:mx-0 space-x-0 md:space-x-10 space-y-10 md:space-y-0 ">
        ...
        <div className="md:min-w-[65vh] min-w-full space-y-10">
          ...
          <section id="home" key="home" className="space-y-5">
            <div className="text-2xl font-bold tracking-tight whitespace-pre-line">{marketingHeadlines.mainHeadline}</div>
            ...
            <div className="flex justify-between">
              ...
              {/* <div className="space-y-1">
                <h3 className="font-medium leading-none">{aboutYou.yearsOfExperience}</h3>
            ...
            <div className="mt-5 rounded-xl border bg-card text-card-foreground shadow">
              <div className="p-6 space-y-6">
                {workExperiences.map((experience: WorkExperience, index: number) => (
                  <WorkShowcase key={experience.company} experience={experience} whetherlast={workExperiences.length == index + 1} />
                ))}
              </div>
            </div>
          </section>
          ...
          <section id="contact" key="contact">
            ...
            <div className="mt-5 rounded-xl border bg-card text-card-foreground shadow">
              <p className="p-6 text-sm text-muted-foreground">
                Best way to reach me and connect is through my email : <a href={`mailto:${aboutYou.email}`}>{aboutYou.email}</a> or <a href="https://wa.me/089671881300">Whatsapp</a>
              </p>
            </div>
          </section>
        </div>
